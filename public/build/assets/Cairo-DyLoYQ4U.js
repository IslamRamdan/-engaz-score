import{r as s,j as t}from"./app-BKVl8zTh.js";import{A as y}from"./AppLayout-BMHssBrh.js";import"./ThemeToggle-B9tEKg1l.js";function N({customer:n,jobs:o}){const[r,l]=s.useState(!1),[x,c]=s.useState(""),[d,h]=s.useState(""),[a,p]=s.useState(null);s.useEffect(()=>{const e=window.prompt("من فضلك أدخل رقم الوكالة:");e&&c(e);const u=window.confirm(`هل تريد إعادة طباعة؟

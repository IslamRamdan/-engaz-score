import{r as s,j as t}from"./app-DWj2KjE6.js";import{A as y}from"./AppLayout-rGW0cSGJ.js";import"./ThemeToggle-Com2LD_U.js";function N({customer:n,jobs:o}){const[r,l]=s.useState(!1),[x,c]=s.useState(""),[d,h]=s.useState(""),[a,p]=s.useState(null);s.useEffect(()=>{const e=window.prompt("من فضلك أدخل رقم الوكالة:");e&&c(e);const u=window.confirm(`هل تريد إعادة طباعة؟

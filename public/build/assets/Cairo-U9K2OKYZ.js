import{r as s,j as t}from"./app-DYq3cWlk.js";import{A as y}from"./AppLayout-D3Xy37kU.js";import"./ThemeToggle-HOvkUsR8.js";function N({customer:n,jobs:o}){const[r,l]=s.useState(!1),[x,c]=s.useState(""),[d,h]=s.useState(""),[a,p]=s.useState(null);s.useEffect(()=>{const e=window.prompt("من فضلك أدخل رقم الوكالة:");e&&c(e);const u=window.confirm(`هل تريد إعادة طباعة؟

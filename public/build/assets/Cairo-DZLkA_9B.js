import{r as s,j as t}from"./app-QAF83biT.js";import{A as y}from"./AppLayout-fhG-c-5V.js";import"./ThemeToggle-CFLNrNJs.js";function N({customer:n,jobs:o}){const[r,l]=s.useState(!1),[x,c]=s.useState(""),[d,h]=s.useState(""),[a,p]=s.useState(null);s.useEffect(()=>{const e=window.prompt("من فضلك أدخل رقم الوكالة:");e&&c(e);const u=window.confirm(`هل تريد إعادة طباعة؟

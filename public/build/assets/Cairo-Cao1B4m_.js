import{r as s,j as t}from"./app-WOQAtObt.js";import{A as f}from"./AppLayout-Do_QdNAy.js";import"./ThemeToggle-C-2XL7nH.js";function k({customer:n,jobs:r}){const[d,x]=s.useState(!1),[a,c]=s.useState(""),[o,h]=s.useState(""),[l,p]=s.useState(null),g=()=>{if(o.trim()===""){alert("من فضلك اكتب التوقيع");return}p(o)},i=n.groups?.[0],j=i?.visa?.sponsor?.name??"-",m=i?.visa?.sponsor?.id_number??"-",b=i?.visa?.issue_number??"-",u=i?.pivot?.e_number??n.e_number??"-";return i?.notes,t.jsxs(f,{children:[t.jsx("style",{children:`
                * {
                    margin: 0;
                    padding: 0;
